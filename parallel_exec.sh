...
parallel -j 4 -u divide_align ::: 5000 2000 1000 500 ::: 0.{4..5}
...
measure_momentum() {
    ...
    ./measure_momentum ${data_dir}/linked_tracks_after_align_binWidth${1}_robustFactor${2}.root after_align_binWidth${1}_robustFactor${2}_icellmax32_${3} "npl>=100&&Entry$%5=="${3}
}
export -f measure_momentum
# parallel -j 5 -u measure_momentum ::: {0..4}
# parallel -j 5 -u measure_momentum ::: 2000 ::: 1.0 0.{6..9} ::: {0..4}
